<template>
  <v-layout row wrap class="myGreen" pa-3 px-5>
    <v-dialog v-model="policy" width="800" scrollable>
      <v-card>
        ...
        <v-card-text>
          ...
          <p>
            Sandro Gugliuzzo<br />
            79539 L&ouml;rrach, T&uuml;llingerstra&szlig;e 61
          </p>

          <p>
            Telefon: 07621 18483<br />
            E-Mail: gnsgyt@gmail.com
          </p>
          <p>
          ...
          <p>
            ...
            YouTube. Betreiber der Seiten ist die Google Ireland Limited
          ...
          <p>
            ...
            Endger&auml;t speichern. Mit Hilfe dieser Cookies kann Youtube
            Informationen &uuml;ber Besucher unserer Website erhalten. Diese
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="primary" flat @click="policy = false">
            Alles klar!
          </v-btn>
        </v-card-actions>
      </v-card>
    ...
    <v-dialog v-model="impressum" width="800" scrollable>
      <v-card>
        ...
        <v-card-text>
          ...
          <p>
            Sandro Gugliuzzo<br />
            T&uuml;llingerstra&szlig;e 61<br />
            79539 L&ouml;rrach
          </p>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="primary" flat @click="impressum = false">
            Alles klar!
          </v-btn>
        </v-card-actions>
      </v-card>
    ...
    <v-flex xs6>
      Entwickelt von <a href="https://skamps.eu" target="_blank">Leo</a> mit
      ganz viel ❤️
    </v-flex>
    <v-flex xs6 text-xs-right>
      <span class="clickAble" @click="policy = !policy">
        Datenschutzerklärung
      </span>
      <span class="clickAble pl-3" @click="impressum = !impressum">
        Impressum
      </span>
    </v-flex>
  </v-layout>
